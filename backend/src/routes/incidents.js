...
import { createIncidentRecord, deleteIncidentRecord, getIncidentRecords, updateIndidentRecord } from "../controllers/incidentController.js";

const router = express.Router();

router.get('/', authenticate, getIncidentRecords);
router.post('/', authenticate, createIncidentRecord);
router.put('/:id', authenticate, updateIndidentRecord);
router.delete('/:id', authenticate, deleteIncidentRecord);
